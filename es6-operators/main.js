...
const cfg1 = v1 ?? 'default-vaule';
const cfg2 = v2 ?? 'default-vaule';
const cfg3 = v3 ?? 'default-vaule';
...
const truthy = (par) => par ? 'truthy' : 'falsy';
const tern1 = truthy(v1);
const tern2 = truthy(v2);
